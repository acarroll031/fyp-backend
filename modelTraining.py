...
def train_model(file_root_1,file_root_2, progress_threshold):
    ...
    # results_df.to_csv(file_root_1 + "grid_search_results_" + progress_threshold + ".csv", index=False)
...
train_model(file_root_1="trainingData/CS161_Data/CS161_Combined_Totals_1_normalised_training_",file_root_2="trainingData/CS161_Data/CS161_Combined_Totals_2_normalised_training_" ,progress_threshold="0.1-1.0")